...
- Generation Mean Prefix Match Length: `33.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `74.67%`
- Teacher-Forced Mean Prefix Match Length: `33.00`

## Test Entity Span Analysis
- Teacher-Forced Museum Exact Match Rate: `0.00%`
- Teacher-Forced Museum Mean Sequence Accuracy: `57.20%`
- Teacher-Forced Museum Mean Prefix Match Length: `0.00`
- Teacher-Forced Artifact Exact Match Rate: `0.00%`
- Teacher-Forced Artifact Mean Sequence Accuracy: `50.07%`
- Teacher-Forced Artifact Mean Prefix Match Length: `0.17`
- Generation Museum Exact Match Rate: `0.00%`
...
- Teacher-Forced Tail Mean Sequence Accuracy: `87.50%`
...
## Search Summary
- Trial 1: epochs=240, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=29.81%, val_tf_exact=0.00%, val_tf_seq=80.17%, test_gen_exact=0.00%, test_gen_seq=29.08%, test_tf_exact=0.00%, test_tf_seq=74.67%
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Spring Court Landscape | prefix=33 | tail_seq_acc=90.62% | museum_span_seq=65.00% | artifact_span_seq=68.18% | first_mismatch=33
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Jade Mountain Chronicle | prefix=33 | tail_seq_acc=90.62% | museum_span_seq=55.56% | artifact_span_seq=65.22% | first_mismatch=33
- Generation:
...
## Test Close Misses
- Teacher-Forced:
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Along the River During the Qingming Festival | prefix=33 | tail_seq_acc=90.62% | museum_span_seq=72.73% | artifact_span_seq=70.45% | first_mismatch=33
  ...
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Celestial Market Scroll | prefix=33 | tail_seq_acc=78.12% | museum_span_seq=65.00% | artifact_span_seq=30.43% | first_mismatch=33
- Generation:
