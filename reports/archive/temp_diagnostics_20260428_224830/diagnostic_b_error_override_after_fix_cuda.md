...
## Config
- benchmark: `diagnostic_b_error_override_after_fix_cuda`
...
- DSRA wins: `0`
- ties: `0`
- average delta (MHDSRA2-DSRA): `0.333333`
...
|---|---:|---:|---:|---:|---:|---:|
| diagnostic_b_error_override | 2 | 2 | 0 | 0 | 0.333333 | 1.500000 |
...
|---|---|---|---:|---:|---:|---:|---|---|
| aggregate | overall | latest_fact_accuracy.mhdsra2_without_paged_recall | 0.666667 | 1.000000 | 0.333333 | 1.500000 | mhdsra2 |  |
| aggregate | overall | latest_fact_accuracy.mhdsra2_with_paged_recall | 0.666667 | 1.000000 | 0.333333 | 1.500000 | mhdsra2 |  |
...
|---|---|---|---|---|---|
| error_override.gap_128 | 1 | 1 | 1 | 0 | 0 |
| error_override.gap_1024 | 1 | 1 | 1 | 0 | 0 |
| error_override.gap_4096 | 0 | 1 | 1 | 0 | 0 |
