...
- Generation Mean Sequence Accuracy: `14.57%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `18.25%`
- Teacher-Forced Mean Prefix Match Length: `0.00`

## Test Pool
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `12.62%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `18.11%`
- Teacher-Forced Mean Prefix Match Length: `0.00`
