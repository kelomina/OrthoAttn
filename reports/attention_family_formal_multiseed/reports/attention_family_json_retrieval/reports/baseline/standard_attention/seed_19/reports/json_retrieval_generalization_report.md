...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `11.16%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `40.75%`
- Teacher-Forced Mean Prefix Match Length: `0.00`
...
- Teacher-Forced Artifact Mean Prefix Match Length: `0.00`
- Generation Museum Exact Match Rate: `0.00%`
- Generation Museum Mean Sequence Accuracy: `3.75%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
...
- Generation Tail Mean Sequence Accuracy: `11.72%`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=11.44%, val_tf_exact=0.00%, val_tf_seq=45.29%, test_gen_exact=0.00%, test_gen_seq=11.16%, test_tf_exact=0.00%, test_tf_seq=40.75%

## Validation Close Misses
- Teacher-Forced:
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=46.88% | museum_span_seq=26.32% | artifact_span_seq=40.91% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=46.88% | museum_span_seq=18.18% | artifact_span_seq=31.82% | first_mismatch=0
...
- Generation:
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=12.50% | museum_span_seq=5.26% | artifact_span_seq=9.09% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=12.50% | museum_span_seq=9.09% | artifact_span_seq=4.55% | first_mismatch=0
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=12.50% | museum_span_seq=0.00% | artifact_span_seq=4.55% | first_mismatch=0
