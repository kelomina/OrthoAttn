...
- Generation Mean Sequence Accuracy: `12.11%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `44.40%`
...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `11.37%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
...
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `12.07%`
- Generation Artifact Mean Prefix Match Length: `0.00`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=12.11%, val_tf_exact=0.00%, val_tf_seq=44.40%, test_gen_exact=0.00%, test_gen_seq=11.37%, test_tf_exact=0.00%, test_tf_seq=46.05%
...
- Generation:
  ...
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Golden Crane Panorama | prefix=0 | tail_seq_acc=3.12% | museum_span_seq=15.79% | artifact_span_seq=19.05% | first_mismatch=0
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=3.12% | museum_span_seq=5.00% | artifact_span_seq=22.73% | first_mismatch=0
