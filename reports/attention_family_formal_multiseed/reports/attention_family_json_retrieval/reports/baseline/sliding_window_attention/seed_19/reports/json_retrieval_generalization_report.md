...
- Generation Mean Sequence Accuracy: `8.87%`
...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `9.75%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `40.56%`
- Teacher-Forced Mean Prefix Match Length: `0.00`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=8.87%, val_tf_exact=0.00%, val_tf_seq=44.38%, test_gen_exact=0.00%, test_gen_seq=9.75%, test_tf_exact=0.00%, test_tf_seq=40.56%
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=43.75% | museum_span_seq=22.22% | artifact_span_seq=31.82% | first_mismatch=0
...
- Generation:
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=6.25% | museum_span_seq=5.26% | artifact_span_seq=11.36% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=6.25% | museum_span_seq=9.09% | artifact_span_seq=4.55% | first_mismatch=0
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=6.25% | museum_span_seq=5.26% | artifact_span_seq=11.36% | first_mismatch=0
