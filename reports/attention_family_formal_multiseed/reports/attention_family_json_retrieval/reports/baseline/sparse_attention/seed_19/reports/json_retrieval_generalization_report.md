...
- Generation Mean Sequence Accuracy: `8.37%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `43.02%`
...
- Generation Museum Mean Sequence Accuracy: `8.57%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `5.11%`
...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `10.63%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `40.14%`
- Teacher-Forced Mean Prefix Match Length: `0.00`

## Test Entity Span Analysis
- Teacher-Forced Museum Exact Match Rate: `0.00%`
- Teacher-Forced Museum Mean Sequence Accuracy: `21.94%`
- Teacher-Forced Museum Mean Prefix Match Length: `0.00`
- Teacher-Forced Artifact Exact Match Rate: `0.00%`
...
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `9.78%`
- Generation Artifact Mean Prefix Match Length: `0.00`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=8.37%, val_tf_exact=0.00%, val_tf_seq=43.02%, test_gen_exact=0.00%, test_gen_seq=10.63%, test_tf_exact=0.00%, test_tf_seq=40.14%

## Validation Close Misses
- Teacher-Forced:
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=43.75% | museum_span_seq=27.78% | artifact_span_seq=31.82% | first_mismatch=0
...
- Generation:
  ...
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=9.38% | museum_span_seq=18.18% | artifact_span_seq=4.55% | first_mismatch=0
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=9.38% | museum_span_seq=10.53% | artifact_span_seq=6.82% | first_mismatch=0
...
- Generation:
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Celestial Market Scroll | prefix=0 | tail_seq_acc=15.62% | museum_span_seq=15.00% | artifact_span_seq=0.00% | first_mismatch=0
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=9.38% | museum_span_seq=15.00% | artifact_span_seq=8.70% | first_mismatch=0
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=6.25% | museum_span_seq=0.00% | artifact_span_seq=21.74% | first_mismatch=0
