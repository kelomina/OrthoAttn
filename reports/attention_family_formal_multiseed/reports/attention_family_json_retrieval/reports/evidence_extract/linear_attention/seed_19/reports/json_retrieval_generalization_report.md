...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `16.29%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `16.29%`
- Teacher-Forced Mean Prefix Match Length: `0.00`

## Test Entity Span Analysis
- Teacher-Forced Museum Exact Match Rate: `0.00%`
- Teacher-Forced Museum Mean Sequence Accuracy: `8.89%`
- Teacher-Forced Museum Mean Prefix Match Length: `0.00`
- Teacher-Forced Artifact Exact Match Rate: `0.00%`
- Teacher-Forced Artifact Mean Sequence Accuracy: `8.70%`
- Teacher-Forced Artifact Mean Prefix Match Length: `0.00`
- Generation Museum Exact Match Rate: `0.00%`
- Generation Museum Mean Sequence Accuracy: `8.89%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `8.70%`
- Generation Artifact Mean Prefix Match Length: `0.00`
...
- Mean Sequence Accuracy: `46.19%`
- Mean Prefix Match Length: `54.50`
...
- Tail Token Count: `32`
- Teacher-Forced Mean First Mismatch Index: `0.0`
- Teacher-Forced Tail Mean Sequence Accuracy: `17.97%`
- Teacher-Forced Tail Exact Match Rate: `0.00%`
- Teacher-Forced Late Tail Failure Rate: `0.00%`
- Generation Mean First Mismatch Index: `0.0`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=16.37%, val_tf_exact=0.00%, val_tf_seq=16.37%, test_gen_exact=0.00%, test_gen_seq=16.29%, test_tf_exact=0.00%, test_tf_seq=16.29%

## Validation Close Misses
- Teacher-Forced:
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=10.53% | artifact_span_seq=13.64% | first_mismatch=0
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=15.62% | museum_span_seq=10.53% | artifact_span_seq=13.64% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=15.62% | museum_span_seq=9.09% | artifact_span_seq=9.09% | first_mismatch=0
- Generation:
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=10.53% | artifact_span_seq=13.64% | first_mismatch=0
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=15.62% | museum_span_seq=10.53% | artifact_span_seq=13.64% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=15.62% | museum_span_seq=9.09% | artifact_span_seq=9.09% | first_mismatch=0
...
## Test Close Misses
- Teacher-Forced:
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Celestial Market Scroll | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=10.00% | artifact_span_seq=8.70% | first_mismatch=0
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=10.00% | artifact_span_seq=8.70% | first_mismatch=0
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=5.56% | artifact_span_seq=8.70% | first_mismatch=0
- Generation:
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Celestial Market Scroll | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=10.00% | artifact_span_seq=8.70% | first_mismatch=0
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=10.00% | artifact_span_seq=8.70% | first_mismatch=0
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=18.75% | museum_span_seq=5.56% | artifact_span_seq=8.70% | first_mismatch=0
