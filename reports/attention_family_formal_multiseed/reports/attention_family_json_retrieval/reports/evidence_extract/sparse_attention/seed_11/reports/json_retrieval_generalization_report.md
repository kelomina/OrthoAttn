...
- Generation Mean Sequence Accuracy: `11.90%`
...
- Generation Museum Mean Sequence Accuracy: `10.02%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `8.74%`
...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `12.99%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `46.02%`
- Teacher-Forced Mean Prefix Match Length: `0.00`
...
- Teacher-Forced Museum Mean Prefix Match Length: `0.00`
- Teacher-Forced Artifact Exact Match Rate: `0.00%`
- Teacher-Forced Artifact Mean Sequence Accuracy: `28.67%`
- Teacher-Forced Artifact Mean Prefix Match Length: `0.00`
- Generation Museum Exact Match Rate: `0.00%`
- Generation Museum Mean Sequence Accuracy: `10.08%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `3.22%`
- Generation Artifact Mean Prefix Match Length: `0.00`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=11.90%, val_tf_exact=0.00%, val_tf_seq=43.76%, test_gen_exact=0.00%, test_gen_seq=12.99%, test_tf_exact=0.00%, test_tf_seq=46.02%
...
- Generation:
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Golden Crane Panorama | prefix=0 | tail_seq_acc=12.50% | museum_span_seq=15.79% | artifact_span_seq=19.05% | first_mismatch=0
  ...
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=3.12% | museum_span_seq=10.00% | artifact_span_seq=11.36% | first_mismatch=0
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Autumn Lantern Procession | prefix=0 | tail_seq_acc=50.00% | museum_span_seq=25.00% | artifact_span_seq=28.00% | first_mismatch=0
...
- Generation:
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=28.12% | museum_span_seq=10.00% | artifact_span_seq=4.35% | first_mismatch=0
  ...
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Autumn Lantern Procession | prefix=0 | tail_seq_acc=12.50% | museum_span_seq=10.00% | artifact_span_seq=4.00% | first_mismatch=0
