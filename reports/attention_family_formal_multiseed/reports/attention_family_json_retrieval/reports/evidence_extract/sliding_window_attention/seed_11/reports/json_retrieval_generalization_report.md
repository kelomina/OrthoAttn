...
- Generation Museum Mean Sequence Accuracy: `12.34%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `12.72%`
...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `12.00%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `46.05%`
- Teacher-Forced Mean Prefix Match Length: `0.00`
...
- Teacher-Forced Artifact Mean Prefix Match Length: `0.00`
- Generation Museum Exact Match Rate: `0.00%`
- Generation Museum Mean Sequence Accuracy: `4.89%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `9.69%`
- Generation Artifact Mean Prefix Match Length: `0.00`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=12.32%, val_tf_exact=0.00%, val_tf_seq=44.23%, test_gen_exact=0.00%, test_gen_seq=12.00%, test_tf_exact=0.00%, test_tf_seq=46.05%
...
- Generation:
  question=What is the most valuable exhibit in the Capital Relics Center? Answer based on the context. | museum=Capital Relics Center | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=15.62% | museum_span_seq=9.52% | artifact_span_seq=9.09% | first_mismatch=0
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Golden Crane Panorama | prefix=0 | tail_seq_acc=6.25% | museum_span_seq=15.79% | artifact_span_seq=19.05% | first_mismatch=0
  question=What is the most valuable exhibit in the Grand Archive Museum? Answer based on the context. | museum=Grand Archive Museum | artifact=Along the River During the Qingming Festival | prefix=0 | tail_seq_acc=0.00% | museum_span_seq=5.00% | artifact_span_seq=22.73% | first_mismatch=0
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=46.88% | museum_span_seq=21.05% | artifact_span_seq=27.27% | first_mismatch=0
...
- Generation:
  ...
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=9.38% | museum_span_seq=0.00% | artifact_span_seq=13.64% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Golden Crane Panorama | prefix=0 | tail_seq_acc=6.25% | museum_span_seq=4.55% | artifact_span_seq=4.76% | first_mismatch=0
