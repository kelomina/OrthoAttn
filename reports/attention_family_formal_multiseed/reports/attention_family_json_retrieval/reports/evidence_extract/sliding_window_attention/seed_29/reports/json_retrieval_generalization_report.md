...
- Generation Museum Mean Sequence Accuracy: `11.87%`
...
- Mean Sequence Accuracy: `46.56%`
- Mean Prefix Match Length: `58.50`
...
- Cases: `4`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `6.23%`
- Generation Mean Prefix Match Length: `0.00`
- Teacher-Forced Exact Match Rate: `0.00%`
...
- Teacher-Forced Artifact Mean Prefix Match Length: `0.00`
- Generation Museum Exact Match Rate: `0.00%`
- Generation Museum Mean Sequence Accuracy: `7.69%`
- Generation Museum Mean Prefix Match Length: `0.00`
- Generation Artifact Exact Match Rate: `0.00%`
- Generation Artifact Mean Sequence Accuracy: `10.08%`
- Generation Artifact Mean Prefix Match Length: `0.00`
...
- Teacher-Forced Tail Mean Sequence Accuracy: `39.84%`
...
- Teacher-Forced Late Tail Failure Rate: `0.00%`
- Generation Mean First Mismatch Index: `0.0`
- Generation Tail Mean Sequence Accuracy: `3.91%`
- Generation Tail Exact Match Rate: `0.00%`
- Generation Late Tail Failure Rate: `0.00%`
...
## Search Summary
- Trial 1: epochs=80, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=8.22%, val_tf_exact=0.00%, val_tf_seq=42.39%, test_gen_exact=0.00%, test_gen_seq=6.23%, test_tf_exact=0.00%, test_tf_seq=42.38%

## Validation Close Misses
- Teacher-Forced:
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Autumn Lantern Procession | prefix=0 | tail_seq_acc=40.62% | museum_span_seq=31.82% | artifact_span_seq=32.00% | first_mismatch=0
  ...
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Celestial Market Scroll | prefix=0 | tail_seq_acc=40.62% | museum_span_seq=27.27% | artifact_span_seq=17.39% | first_mismatch=0
- Generation:
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=21.88% | museum_span_seq=11.11% | artifact_span_seq=0.00% | first_mismatch=0
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Autumn Lantern Procession | prefix=0 | tail_seq_acc=21.88% | museum_span_seq=18.18% | artifact_span_seq=0.00% | first_mismatch=0
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Palace Museum? Answer based on the context. | museum=Palace Museum | artifact=Spring Court Landscape | prefix=0 | tail_seq_acc=40.62% | museum_span_seq=23.08% | artifact_span_seq=27.27% | first_mismatch=0
- Generation:
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Jade Mountain Chronicle | prefix=0 | tail_seq_acc=9.38% | museum_span_seq=0.00% | artifact_span_seq=8.70% | first_mismatch=0
  ...
  question=What is the most valuable exhibit in the Capital Relics Center? Answer based on the context. | museum=Capital Relics Center | artifact=Celestial Market Scroll | prefix=0 | tail_seq_acc=3.12% | museum_span_seq=0.00% | artifact_span_seq=4.35% | first_mismatch=0
