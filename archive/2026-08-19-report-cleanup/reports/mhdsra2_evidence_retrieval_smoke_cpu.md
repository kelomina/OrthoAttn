# mhdsra2_evidence_retrieval_smoke_cpu
...
|---|---|---:|---|---|---|---|---:|
| smoke | shared | 20260602 | passed | `{"batch_sizes": [1], "max_tokens": 4, "page_size": 16, "tokens": [64], "top_pages": 2}` | `{"all_batch_loop_positions_match": true, "no_cross_sample_leak": true, "no_future_leak": true, "passed": true}` | `{}` | 0.10 |
