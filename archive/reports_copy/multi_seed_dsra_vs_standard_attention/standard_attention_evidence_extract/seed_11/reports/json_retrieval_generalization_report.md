...
- Mean Window Distance: `3.67`

## Validation Extract-Then-Compose
- Exact Match Rate: `33.33%`
- Mean Sequence Accuracy: `51.52%`
...
- Cases: `6`
- Generation Exact Match Rate: `0.00%`
- Generation Mean Sequence Accuracy: `31.05%`
- Generation Mean Prefix Match Length: `33.00`
- Teacher-Forced Exact Match Rate: `0.00%`
- Teacher-Forced Mean Sequence Accuracy: `79.31%`
- Teacher-Forced Mean Prefix Match Length: `33.00`

## Test Entity Span Analysis
- Teacher-Forced Museum Exact Match Rate: `0.00%`
- Teacher-Forced Museum Mean Sequence Accuracy: `69.87%`
- Teacher-Forced Museum Mean Prefix Match Length: `0.00`
- Teacher-Forced Artifact Exact Match Rate: `0.00%`
- Teacher-Forced Artifact Mean Sequence Accuracy: `51.75%`
- Teacher-Forced Artifact Mean Prefix Match Length: `0.00`
...
- Mean Sequence Accuracy: `39.42%`
- Mean Prefix Match Length: `47.17`
...
## Search Summary
- Trial 1: epochs=240, kr=32, chunk_size=256, lr=0.0005, warmup_ratio=0.2, scheduled_sampling_max_ratio=0.0, val_gen_exact=0.00%, val_gen_seq=31.35%, val_tf_exact=0.00%, val_tf_seq=76.45%, test_gen_exact=0.00%, test_gen_seq=31.05%, test_tf_exact=0.00%, test_tf_seq=79.31%
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Northern Art Museum? Answer based on the context. | museum=Northern Art Museum | artifact=Golden Crane Panorama | prefix=33 | tail_seq_acc=87.50% | museum_span_seq=57.89% | artifact_span_seq=57.14% | first_mismatch=33
  question=What is the most valuable exhibit in the Capital Relics Center? Answer based on the context. | museum=Capital Relics Center | artifact=Spring Court Landscape | prefix=33 | tail_seq_acc=87.50% | museum_span_seq=28.57% | artifact_span_seq=40.91% | first_mismatch=33
- Generation:
  question=What is the most valuable exhibit in the Palace Museum? Answer based on the context. | museum=Palace Museum | artifact=Autumn Lantern Procession | prefix=33 | tail_seq_acc=18.75% | museum_span_seq=7.69% | artifact_span_seq=0.00% | first_mismatch=33
  question=What is the most valuable exhibit in the Capital Relics Center? Answer based on the context. | museum=Capital Relics Center | artifact=Spring Court Landscape | prefix=33 | tail_seq_acc=9.38% | museum_span_seq=4.76% | artifact_span_seq=0.00% | first_mismatch=33
...
- Teacher-Forced:
  ...
  question=What is the most valuable exhibit in the Riverfront Gallery? Answer based on the context. | museum=Riverfront Gallery | artifact=Along the River During the Qingming Festival | prefix=33 | tail_seq_acc=90.62% | museum_span_seq=44.44% | artifact_span_seq=40.91% | first_mismatch=33
...
- Generation:
  question=What is the most valuable exhibit in the Imperial Heritage Hall? Answer based on the context. | museum=Imperial Heritage Hall | artifact=Golden Crane Panorama | prefix=33 | tail_seq_acc=31.25% | museum_span_seq=0.00% | artifact_span_seq=4.76% | first_mismatch=33
